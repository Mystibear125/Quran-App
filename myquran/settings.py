...
EMAIL_HOST_USER = config('habibliadi5@gmail.com')  # your Gmail
EMAIL_HOST_PASSWORD = config('wvdj ptsx bgen ytzq')  # Gmail App Password
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default=f'Al-Qur\'an <{EMAIL_HOST_USER}>')
